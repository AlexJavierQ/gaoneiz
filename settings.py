...
INSTALLED_APPS = [
    ...
    # Mis Aplicaciones
    'app_camara_comercio.apps.AppCamaraComercioConfig',
...
AUTH_USER_MODEL = 'app_camara_comercio.Persona'
...
# Configuración de django-allauth (versión moderna y sin advertencias)
SITE_ID = 1
...
LOGIN_URL = 'account_login' # Usa la URL de allauth
